...
int main(int argc, char *argv[])
{
    ...
    const double h_conv = 10.0;         // Convection coefficient [W/m²/K]
    ...
    Array<int> bc_x0(mesh.bdr_attributes.Max()); bc_x0 = 0; bc_x0[0] = 1;
    Array<int> bc_xL(mesh.bdr_attributes.Max()); bc_xL = 0; bc_xL[1] = 1;
